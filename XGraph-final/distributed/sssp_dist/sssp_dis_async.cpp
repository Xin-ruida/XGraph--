...
void sssp_dis_async(ArgumentParser arguments)
{
    MPI_Init(NULL, NULL);
    ...
    sssp_async(graph, states, graph_value, false, arguments.sourceNode);
    ...
    while (true)
    {
        ...
        bool end = sssp_async(graph, states, graph_value);
        if (end) myFlag = 0;
        else myFlag = 1;
